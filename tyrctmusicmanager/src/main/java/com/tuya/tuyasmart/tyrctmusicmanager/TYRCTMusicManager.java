package com.tuya.tuyasmart.tyrctmusicmanager;

import android.util.Log;

public class TYRCTMusicManager {
    ...
    private static String TAG = TYRCTMusicManager.class.getSimpleName();
    ...
    public void tag(final String tag) {
        if (tag != null) {
            ...
            TAG = TYRCTMusicManager.class.getSimpleName();
        }
    }
