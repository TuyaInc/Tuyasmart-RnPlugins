package com.tuya.tuyasmart.tyrctpanelmanager;

import android.util.Log;

public class TYRCTPanelManager {
    ...
    private static String TAG = TYRCTPanelManager.class.getSimpleName();
    ...
    public void tag(final String tag) {
        if (tag != null) {
            ...
            TAG = TYRCTPanelManager.class.getSimpleName();
        }
    }
